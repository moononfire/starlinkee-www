...
const copy: Record<Locale, Copy> = {
  pl: {
    ...
    steps: [
      ...
      "Jeśli trafiłeś tutaj po zbliżeniu telefonu do nadajnika NFC — po zainstalowaniu aplikacji przyłóż telefon do niego jeszcze raz, żeby odebrać pieczątkę (instalacja sama tego nie robi).",
    ],
  ...
  en: {
    ...
    steps: [
      ...
      "If you got here by tapping your phone on an NFC reader — after installing the app, tap it again to collect your stamp (installing alone doesn't do that automatically).",
    ],
  ...
  de: {
    ...
    steps: [
      ...
      "Bist du über ein NFC-Lesegerät hierhergekommen? Halte dein Telefon nach der Installation noch einmal daran, um den Stempel zu erhalten (die Installation allein macht das nicht automatisch).",
    ],
  ...
  it: {
    ...
    steps: [
      ...
      "Sei arrivato qui avvicinando il telefono a un lettore NFC? Dopo l'installazione, avvicinalo di nuovo per ricevere il timbro (l'installazione da sola non lo fa automaticamente).",
    ],
