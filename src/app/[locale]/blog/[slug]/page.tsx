      ...
      <main className="min-h-screen bg-white overflow-x-hidden">
       <OpenLinksInNewTab>
        ...
        <article>
          ...
          {/* CTA */}
          <aside className="mt-14 bg-gradient-to-br from-blue-500 to-blue-700 py-14 text-white">
            <div className="max-w-3xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row items-center gap-8 md:gap-12 text-center md:text-left">
              <Link href={`/${requestedLocale}/order`} className="w-full max-w-[340px] md:max-w-none md:w-1/2 aspect-square relative shrink-0 block">
                <Image
                  src={`/product-transparent/${requestedLocale}.webp`}
